...
The `scrape_objects()` function will:
...
- **Simple workflow**: (1) Create list of Scrape objects with `fa_create_date_range_scrape()`, (2) Scrape each with `scrape_objects()`, (3) Pass directly to analysis functions
