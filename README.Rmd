...
summary_table <- fa_flex_table(scrape)
best_dates <- fa_best_dates(scrape, n = 5)
```
...
best_dates_median <- fa_best_dates(scrapes, n = 5, by = "median")
best_dates_min <- fa_best_dates(scrapes, n = 5, by = "min")
```
