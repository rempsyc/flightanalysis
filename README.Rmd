...
- **Simple workflow**: (1) Create list of Scrape objects with `create_date_range()`, (2) Scrape each with `fetch_flights()`, (3) Pass directly to analysis functions
...
# Scrape directly
scraped <- fetch_flights(scrape, verbose = TRUE)
