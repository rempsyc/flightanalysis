...
This is an initial R port of the Python package. The core data structures and API are implemented. Web scraping functionality is fully implemented using the chromote package via the ScrapeObjects function in R/scrape.R.
