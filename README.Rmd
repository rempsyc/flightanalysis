...
1. Automatically set up Chrome/Chromium browser
2. Navigate to Google Flights URLs
3. Extract flight information
4. Parse prices, times, airlines, stops, and emissions
5. Store results in the Scrape object's `data` field
