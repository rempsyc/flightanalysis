...
best_dates <- fa_find_best_dates(results, n = 10, by = "mean")
...
# 
# # Scrape the data
# query_single <- fa_fetch_flights(query_single, verbose = TRUE)
# 
# # Analyze single origin
# best_dates_single <- fa_find_best_dates(query_single, n = 5, by = "min")
