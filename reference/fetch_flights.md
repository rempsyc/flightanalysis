...
``` r
fetch_flights(queries, verbose = TRUE)

ScrapeObjects(queries, verbose = TRUE)

scrape_objects(queries, verbose = TRUE)
```
...
- queries:
  ...
  A flight query object or list of query objects (from define_query())
