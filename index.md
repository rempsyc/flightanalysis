...
**Store results** - Save data in the query object’s `data` field 6.
...
|:-----|:--------|:-----------|:-----------|:-----------|:-----------|:-----------|:-----------|:-----------|:------------------------|
| BOM  | BOM     | \$ 693     | \$ 756     | \$ 773     | \$ 908     | \$1,055    | \$1,631    | \$1,492    | $1,044{||}DEL|DEL|$ 605 |
| PAT  | PAT     | \$1,059    | \$1,166    | \$1,419    | \$1,490    | \$1,868    | \$2,471    | \$2,469    | $1,706{||}VNS|VNS|$ 934 |
...
(2) Scrape each with
[`fa_fetch_flights()`](https://rempsyc.github.io/flightanalysis/reference/fa_fetch_flights.md),
(3) Pass directly to analysis functions - **Direct query object
support**:
...
accept lists of query objects directly - no manual data processing
needed! - Search multiple origin airports and dates efficiently -
Automatically leverages existing chain-trip functionality - Automatic
filtering of placeholder rows - Create wide summary tables for easy
price comparison - Identify cheapest travel dates automatically -
...
The
[`fa_summarize_prices()`](https://rempsyc.github.io/flightanalysis/reference/fa_summarize_prices.md)
function creates a wide summary table showing prices by city/airport and
date:
...
The
[`fa_find_best_dates()`](https://rempsyc.github.io/flightanalysis/reference/fa_find_best_dates.md)
function identifies the cheapest travel dates:
...
tables with
[`fa_summarize_prices()`](https://rempsyc.github.io/flightanalysis/reference/fa_summarize_prices.md)
for easy price comparison - ✅ **NEW:** Best date identification with
[`fa_find_best_dates()`](https://rempsyc.github.io/flightanalysis/reference/fa_find_best_dates.md)
for finding cheapest travel dates
